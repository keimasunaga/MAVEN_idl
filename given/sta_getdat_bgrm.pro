PRO sta_getdat_bgrm, dat, dat_new, ratio=ratio
  ...
  data[wp] = dat_new.cnts[wp]   ;;add original proton data into proton channels which are affected by proton subtraction done above 
