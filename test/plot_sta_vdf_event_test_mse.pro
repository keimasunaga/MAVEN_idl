...
pro plot_sta_vdf_event_test_mse,orbit,trange=trange,png=png,ps=ps,save=save,event=event,highres=highres,_extra=extra,get_apid=get_apid,len_ratio=len_ratio
...
;    plot_sta_vdf,trange=tspan,/local,/show,units='df',sta_apid='d0',mult='4,3',panel_mode=1,/remove,vdf_sav=vdf_sav
    plot_sta_vdf,dat=dat_new,/local,/mse,/nearest,/show,units='df',sta_apid=get_apid,mult='4,5',panel_mode=1,nbin=800,vres=2.,$
                 /remove,vdf_sav=vdf_sav,_extra=extra,mass_assmpt=16.,mass_range=[12,20],angle=[-45,45],/surf,/save_mse
