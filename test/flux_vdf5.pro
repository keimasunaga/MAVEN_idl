...
pro flux_vdf5,dat,orbit=orbit,$
                 ...
                 rmv_vx=rmv_vx,rmv_vsh=rmv_vsh,rmv_ring=rmv_ring,plot_vdf=plot_vdf
    ...
    vec_norm_sh = get_norm_shock2(pos_mse,ind=ind_norm)
  ...
  if keyword_set(plot_vdf) then begin
       ...
       for ip=0,3 do begin
         ...
         for ia=0,15 do begin
            ...
            if agl_xy ge angle_range[0] and agl_xy le angle_range[1] then begin
              ...
              if keyword_set(rmv_ring) then if vdist_from_ring ge vproton_perp_tot*0.9 and vdist_from_ring le vproton_perp_tot*1.1 then Cts_xy[inside_xy] = 0.
            ...
            if agl_yz ge angle_range[0] and agl_yz le angle_range[1] then begin
              ...
              if keyword_set(rmv_ring) then if vdist_from_ring ge vproton_perp_tot*0.9 and vdist_from_ring le vproton_perp_tot*1.1 then Cts_yz[inside_yz] = 0.
            ...
            if agl_xz ge angle_range[0] and agl_xz le angle_range[1] then begin
              ...
              if keyword_set(rmv_ring) then if vdist_from_ring ge vproton_perp_tot*0.9 and vdist_from_ring le vproton_perp_tot*1.1 then Cts_xz[inside_xz] = 0.
            ...
            if not keyword_set(mso) then begin
              ...
              if keyword_set(rmv_ring) then if vdist_from_ring ge vproton_perp_tot*0.9 and vdist_from_ring le vproton_perp_tot*1.1 then Cts_paraperp[inside_paraperp] = 0.
   ...
   ;;calculate surface angle of IMB
    ...
    if keyword_set(plot_vdf) then begin
    xyouts,-4*vrange[1],vrange[1]+0.9*vrange[1],'N_gt10kev: '+string(Odens_gt10kev[0],format='(f12.7)')+'/cm3',/data
    xyouts,-4*vrange[1],vrange[1]+0.8*vrange[1],'N_gt1kev: '+string(Odens_gt1kev[0],format='(f12.7)')+'/cm3',/data
    xyouts,-4*vrange[1],vrange[1]+0.7*vrange[1],'N_100ev: '+string(Odens_100ev[0],format='(f12.7)')+'/cm3',/data
    xyouts,-4*vrange[1],vrange[1]+0.6*vrange[1],'V_gt10kev: '+string(Ovel_mso_gt10kev[0],format='(f7.2)')+','+string(Ovel_mso_gt10kev[1],format='(f7.2)')+','+string(Ovel_mso_gt10kev[2],format='(f7.2)')+' km/s',/data
    xyouts,-4*vrange[1],vrange[1]+0.5*vrange[1],'V_gt1kev: '+string(Ovel_mso_gt1kev[0],format='(f7.2)')+','+string(Ovel_mso_gt1kev[1],format='(f7.2)')+','+string(Ovel_mso_gt1kev[2],format='(f7.2)')+' km/s',/data
    xyouts,-4*vrange[1],vrange[1]+0.4*vrange[1],'V_100ev: '+string(Ovel_mso_100ev[0],format='(f7.2)')+','+string(Ovel_mso_100ev[1],format='(f7.2)')+','+string(Ovel_mso_100ev[2],format='(f7.2)')+' km/s',/data
