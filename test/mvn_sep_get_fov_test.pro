...
Function mvn_sep_get_fov_test, times,nphi = nphi, ntheta=ntheta, check_objects = check_objects, coordinate_frame = coordinate_frame, $
  Cartesian = Cartesian
...
; define a two-dimensional array of phi, theta
    ...
    phi_edges_2d = phi_edges_array#replicate (1.0,ntheta+1)
    theta_edges_2d = phi_edges_array##replicate (1.0,nphi+1)
...
; transform back to Cartesian coordinates (still in the SEP sensor coordinate frame)
    ...
    spc2cart, 1.0, theta_edges_2d, phi_edges_2d, x2d_ed, y2d_ed, z2d_ed
