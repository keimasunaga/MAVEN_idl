pro main_save_flux_vdf6
   
   orbit_arr = 1590 + indgen(500)
   rmv_orbit = [409,470,471,545,637,638,$
                1695+indgen(13)]
   orbit_spice_load = [372,408,628,665,$
                       1480,1530,1580,1590,1630,1680,1730,1780,1830,1880,1930]
   for qq=0,n_elements(orbit_arr)-1 do begin
    ...
    save_flux_vdf6,orbit_arr[qq],get_apid='d0',/save,spice_load=spice_load;,/plot_vdf
    skip_save:
   endfor
