...
pro mvn_sta_add_magf_test, bdata = bdata, verbose = verbose
...
spice_vector_rotate_tplot,bdata,'MAVEN_STATIC',verbose=verbose

get_data,bdata+'_MAVEN_STATIC',data = bswia
