...
pro save_flux_vdf6,orbit,trange=trange,png=png,ps2pdf=ps2pdf,ps2png=ps2png,save=save,event=event,highres=highres,_extra=extra,get_apid=get_apid,$
  ...
  if keyword_set(spice_load) then mvn_spice_load_kei,trange=trange
  ...
  for it = 0,n_elements(time)-1 do begin
    ...
    ;if keyword_set(plot_vdf) then flux_vdf5,dat_new,orbit=orbit,/local,/show,units='df',sta_apid=get_apid,mult='4,5',panel_mode=2,nbin=800,vres=2.,$
    ;              /remove,_extra=extra,mass_assmpt=16.,mass_range=[12,20],angle=[-45,45],/surf,/plot_vdf
    flux_vdf6,dat_new,orbit=orbit,/local,/show,units='df',sta_apid=get_apid,mult='4,5',panel_mode=1,nbin=800,vres=2.,$
      /remove,vdf_sav=vdf_sav_out_sh,_extra=extra,mass_assmpt=16.,mass_range=[12,20],angle=[-45,45],/surf,$
      rmv_vsh=-1,/rmv_ring,/plot_vdf
    
    flux_vdf6,dat_new,orbit=orbit,/local,/show,units='df',sta_apid=get_apid,mult='4,5',panel_mode=1,nbin=800,vres=2.,$
      /remove,vdf_sav=vdf_sav_in_sh,_extra=extra,mass_assmpt=16.,mass_range=[12,20],angle=[-45,45],/surf,$
      rmv_vsh=1,plot_vdf=plot_vdf
    
   
;    flux_vdf5,dat_new,orbit=orbit,/local,/show,units='df',sta_apid=get_apid,mult='4,5',panel_mode=1,nbin=800,vres=2.,$
;                 /remove,vdf_sav=vdf_sav_out_sh,_extra=extra,mass_assmpt=16.,mass_range=[12,20],angle=[-45,45],/surf,$
;                 rmv_vsh=-1;,plot_vdf=plot_vdf
;    
;    flux_vdf5,dat_new,orbit=orbit,/local,/show,units='df',sta_apid=get_apid,mult='4,5',panel_mode=1,nbin=800,vres=2.,$
...
;    
;    flux_vdf5,dat_new,orbit=orbit,/local,/show,units='df',sta_apid=get_apid,mult='4,5',panel_mode=1,nbin=800,vres=2.,$
;                 /remove,vdf_sav=vdf_sav_out_x,_extra=extra,mass_assmpt=16.,mass_range=[12,20],angle=[-45,45],/surf,$
;                 rmv_vx=-1
;    flux_vdf5,dat_new,orbit=orbit,/local,/show,units='df',sta_apid=get_apid,mult='4,5',panel_mode=2,nbin=800,vres=2.,$
;                 /remove,vdf_sav=vdf_sav_in_x,_extra=extra,mass_assmpt=16.,mass_range=[12,20],angle=[-45,45],/surf,$
;                 rmv_vx=1,plot_vdf=plot_vdf
;    
;    flux_vdf5,dat_new,orbit=orbit,/local,/show,units='df',sta_apid=get_apid,mult='4,5',panel_mode=1,nbin=800,vres=2.,$
;                 /remove,vdf_sav=vdf_sav_in_xz,_extra=extra,mass_assmpt=16.,mass_range=[12,20],angle=[-45,45],/surf,$
;                 rmv_vx=2,plot_vdf=plot_vdf             
...
;                vdf_sav_out_x:vdf_sav_out_x,$
;                vdf_sav_in_x:vdf_sav_in_x,$
;                vdf_sav_in_xz:vdf_sav_in_xz}
