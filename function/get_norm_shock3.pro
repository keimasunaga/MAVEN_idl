...
function get_norm_shock3,pos,theta=theta_dash_bin,phi=phi_dash_bin,ind=ind
  ...
  restore, SAVE_LOC + '/maven/sav/shock_normal/shock_normal.sav'
  x_norm_cnt = norm_shock.x_norm_cnt
  y_norm_cnt = norm_shock.y_norm_cnt
  z_norm_cnt = norm_shock.z_norm_cnt
