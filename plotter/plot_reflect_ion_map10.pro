...
pro plot_reflect_ion_map10,energy,vdf_type=vdf_type,surf_type=surf_type,frange=frange,fregion=fregion,$
    ...
    orbit_arr = [336+findgen(500),1470+findgen(500), 2423+findgen(600)];346;,347,348,349,350] ;+ findgen(472)   
    zrange = [1e0,1e5] 
    zrange_n = [1e0,1e3]
   ...
   Pdyn_arr = 0.
    ...
    for in=0,n_elements(orbit_arr)-1 do begin  
      ...
      file_sw = SAVE_LOC + '/maven/sav/solar_wind_info/15min_v1_160513/sw_info_'+string(orbit_arr[in],format='(i05)')+'.sav'
