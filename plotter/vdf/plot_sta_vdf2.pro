...
pro plot_sta_vdf2,trange=trange,load=load,sta_apid=sta_apid,dat=dat,$
    ...
    for ie=0,31 do begin
       ...
       for ip=0,3 do begin
         ...
         for ia=0,15 do begin
            ...
            ; if (v_c[1] gt 0 and v_c[1] gt sqrt(vproton_perp_tot^2 - (v_c[0] - vproton_perp_tot)^2)) or (v_c[1] lt 0 and v_c[1] lt sqrt(vproton_perp_tot^2 - (v_c[0] - vproton_perp_tot)^2)) then begin
   if v_c[2]^2 gt 1.5^2*vproton_perp_tot^2 - (v_c[1] - vproton_perp_tot)^2 then begin
