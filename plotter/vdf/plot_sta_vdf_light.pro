pro vbvec,trange,vb,solar_wind=solar_wind,local=local,mva=mva
  ...
  if keyword_set(local) then begin
    ...
    idx_dens = nn('mvn_swim_density',[trange[0],trange[1]])
    get_data,'mvn_swim_density',t_dens,y_dens
...
pro plot_sta_vdf_light,trange=trange,load=load,sta_apid=sta_apid,dat=dat,$
    ...
    if not keyword_set(mass_assmpt) then mass_assmpt = 1.
    if not keyword_set(mass_range) then mass_range = [3,5]
    ...
    if not keyword_set(nbin) then nbin = 300
    ...
    loadct2,39
    plotxyz,(findgen(nbin+1)-nbin/2.)*vres,(findgen(nbin+1)-nbin/2.)*vres,N_im_xy2,xrange=[-nbin/2.*vres,nbin/2.*vres],yrange=[-nbin/2.*vres,nbin/2.*vres],zrange=[1,100],/zlog,/add,mpanel=mpanel_Nxy,xtit=Vx_tit+' [km/s]',ytit=Vy_tit+' [km/s]',charsize=charsize
    loadct2,0
    plots,circle_v2(0,0,mvn_ev2km(10.,mass_assmpt)),color=180
    plots,circle_v2(0,0,mvn_ev2km(100.,mass_assmpt)),color=180
    plots,circle_v2(0,0,mvn_ev2km(1000.,mass_assmpt)),color=180
    ...
    plotxyz,(findgen(nbin+1)-nbin/2.)*vres,(findgen(nbin+1)-nbin/2.)*vres,im_yz2,xrange=[-nbin/2.*vres,nbin/2.*vres],yrange=[-nbin/2.*vres,nbin/2.*vres],zrange=zrange,/zlog,/add,mpanel=mpanel_imyz,xtit=Vy_tit+' [km/s]',ytit=Vz_tit+' [km/s]',charsize=charsize
    loadct2,0
    plots,circle_v2(0,0,mvn_ev2km(10.,mass_assmpt)),color=180
    plots,circle_v2(0,0,mvn_ev2km(100.,mass_assmpt)),color=180
    plots,circle_v2(0,0,mvn_ev2km(1000.,mass_assmpt)),color=180
    ...
    plotxyz,(findgen(nbin+1)-nbin/2.)*vres,(findgen(nbin+1)-nbin/2.)*vres,N_im_yz2,xrange=[-nbin/2.*vres,nbin/2.*vres],yrange=[-nbin/2.*vres,nbin/2.*vres],zrange=[1,100],/zlog,/add,mpanel=mpanel_Nyz,xtit=Vy_tit+' [km/s]',ytit=Vz_tit+' [km/s]',charsize=charsize
    loadct2,0
    plots,circle_v2(0,0,mvn_ev2km(10.,mass_assmpt)),color=180
    plots,circle_v2(0,0,mvn_ev2km(100.,mass_assmpt)),color=180
    plots,circle_v2(0,0,mvn_ev2km(1000.,mass_assmpt)),color=180
    ...
    plotxyz,(findgen(nbin+1)-nbin/2.)*vres,(findgen(nbin+1)-nbin/2.)*vres,im_xz2,xrange=[-nbin/2.*vres,nbin/2.*vres],yrange=[-nbin/2.*vres,nbin/2.*vres],zrange=zrange,/zlog,/add,mpanel=mpanel_imxz,xtit=Vx_tit+' [km/s]',ytit=Vz_tit+' [km/s]',charsize=charsize
    loadct2,0
    plots,circle_v2(0,0,mvn_ev2km(10.,mass_assmpt)),color=180
    plots,circle_v2(0,0,mvn_ev2km(100.,mass_assmpt)),color=180
    plots,circle_v2(0,0,mvn_ev2km(1000.,mass_assmpt)),color=180
    plots,circle_v2(0,0,mvn_ev2km(10000.,mass_assmpt)),color=180
    loadct2,39
    plotxyz,(findgen(nbin+1)-nbin/2.)*vres,(findgen(nbin+1)-nbin/2.)*vres,N_im_xz2,xrange=[-nbin/2.*vres,nbin/2.*vres],yrange=[-nbin/2.*vres,nbin/2.*vres],zrange=[1,100],/zlog,/add,mpanel=mpanel_Nxz,xtit=Vx_tit+' [km/s]',ytit=Vz_tit+' [km/s]',charsize=charsize
    loadct2,0
    plots,circle_v2(0,0,mvn_ev2km(10.,mass_assmpt)),color=180
    plots,circle_v2(0,0,mvn_ev2km(100.,mass_assmpt)),color=180
    plots,circle_v2(0,0,mvn_ev2km(1000.,mass_assmpt)),color=180
    ...
    plotxyz,(findgen(nbin+1)-nbin/2.)*vres,findgen(nbin/2.+1)*vres,im_paraperp2,xrange=[-nbin/2.*vres,nbin/2.*vres],yrange=[0,nbin/2.*vres],zrange=zrange,/zlog,/add,mpanel=mpanel_imparaperp,xtit='Vpara [km/s]',ytit='Vperp [km/s]',charsize=charsize
    ...
    loadct2,39
    plotxyz,(findgen(nbin+1)-nbin/2.)*vres,findgen(nbin/2.+1)*vres,N_im_paraperp2,xrange=[-nbin/2.*vres,nbin/2.*vres],yrange=[0,nbin/2.*vres],zrange=[1,100],/zlog,/add,mpanel=mpanel_Nparaperp,xtit='Vpara [km/s]',ytit='Vperp [km/s]',charsize=charsize
    plots,vproton_para_tot,vproton_perp_tot,psym=4,thick=2,color=230
    plots,vproton_para_tot/sqrt(mass_assmpt),vproton_perp_tot/sqrt(mass_assmpt),psym=4,thick=2,color=200
    oplot,[0,0],[0,2*vproton_perp_tot],line=2,color=230    
    loadct2,0
