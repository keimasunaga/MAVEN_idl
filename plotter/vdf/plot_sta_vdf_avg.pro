...
pro plot_sta_vdf_avg,orbit_arr,vperp_range=vperp_range,Btrange=Btrange,vperb=vperb,$
   ...
   for hh=0,n_elements(orbit_arr)-1 do begin
     ...
     filename = SAVE_LOC_HEAVY + '/maven/sav/vdf/oxy/'+string(orbit_arr[hh],'(i05)')+'/vdf_*.sav'
     if keyword_set(herium) then filename = SAVE_LOC + '/maven/sav/vdf/herium/'+string(orbit_arr[hh],'(i05)')+'/vdf_*.sav'
    ...
    for ii=0,n_elements(fs)-1 do begin
      ...
      if th_v_std*!radeg gt 10. or th_b_std*!radeg gt 10. or R_v lt 0.95 or R_b lt 0.95 then goto,noadd
...
;stop
    noadd:
      ...
      charsize=2
       ...
       plotxyz,(findgen(nbin_acc+1)-nbin_acc/2.)*vres_sw,(findgen(nbin_acc+1)-nbin_acc/2.)*vres_sw,im_xy_avg,/zlog,xrange=[-5,5],yrange=[-5,5],zrange=[1e3,1e6],mult=mult,mpanel=mpanel_imxy,xtit='Vb',ytit='Vexb',charsize=charsize
       oplot,!x.crange,[0,0],line=2
       oplot,[0,0],!y.crange,line=2
       plotxyz,(findgen(nbin_acc+1)-nbin_acc/2.)*vres_sw,(findgen(nbin_acc+1)-nbin_acc/2.)*vres_sw,N_im_xy_acc,/zlog,xrange=[-5,5],yrange=[-5,5],zrange=[1,1e4],/add,mpanel=mpanel_Nxy,xtit='Vb',ytit='Vexb',charsize=charsize
       oplot,!x.crange,[0,0],line=2
       oplot,[0,0],!y.crange,line=2
       ...
       im_yz_avg[idx_yz_zero] = !values.F_NaN
       N_im_yz_acc[idx_yz_zero] = !values.F_NaN
       plotxyz,(findgen(nbin_acc+1)-nbin_acc/2.)*vres_sw,(findgen(nbin_acc+1)-nbin_acc/2.)*vres_sw,im_yz_avg,/zlog,xrange=[-5,5],yrange=[-5,5],zrange=[1e3,1e6],/add,mpanel=mpanel_imyz,xtit='Vexb',ytit='Ve',charsize=charsize
       plots,circle_v2(1,0,1),color=1
       ...
       oplot,!x.crange,[0,0],line=2
       oplot,[0,0],!y.crange,line=2
       plotxyz,(findgen(nbin_acc+1)-nbin_acc/2.)*vres_sw,(findgen(nbin_acc+1)-nbin_acc/2.)*vres_sw,N_im_yz_acc,/zlog,xrange=[-5,5],yrange=[-5,5],zrange=[1,1e4],/add,mpanel=mpanel_Nyz,xtit='Vexb',ytit='Ve',charsize=charsize
       plots,circle_v2(1,0,1),color=1
       ;plots,circle_v2(sqrt(2.),0,sqrt(2.)),color=1
       ;plots,circle_v2(sqrt(44./16.),0,sqrt(44./16.)),color=1
       plots,circle_v2(1,0,2),color=1
       ...
       plotxyz,(findgen(nbin_acc+1)-nbin_acc/2.)*vres_sw,(findgen(nbin_acc+1)-nbin_acc/2.)*vres_sw,im_xz_avg,/zlog,xrange=[-5,5],yrange=[-5,5],zrange=[1e3,1e6],/add,mpanel=mpanel_imxz,xtit='Vb',ytit='Ve',charsize=charsize
       oplot,!x.crange,[0,0],line=2
       oplot,[0,0],!y.crange,line=2
       plotxyz,(findgen(nbin_acc+1)-nbin_acc/2.)*vres_sw,(findgen(nbin_acc+1)-nbin_acc/2.)*vres_sw,N_im_xz_acc,/zlog,xrange=[-5,5],yrange=[-5,5],zrange=[1,1e4],/add,mpanel=mpanel_Nxz,xtit='Vb',ytit='Ve',charsize=charsize
       oplot,!x.crange,[0,0],line=2
       oplot,[0,0],!y.crange,line=2
       ...
       plotxyz,(findgen(nbin_acc+1)-nbin_acc/2.)*vres_sw,(findgen(nbin_acc/2.+1))*vres_sw,im_paraperp_avg,/zlog,xrange=[-5,5],yrange=[0,5],zrange=[1e3,1e6],/add,mpanel=mpanel_imparaperp,xtit='Vb',ytit='Ve',charsize=charsize
       oplot,!x.crange,[0,0],line=2
       oplot,[0,0],!y.crange,line=2
       plotxyz,(findgen(nbin_acc+1)-nbin_acc/2.)*vres_sw,(findgen(nbin_acc/2.+1))*vres_sw,N_im_paraperp_acc,/zlog,xrange=[-5,5],yrange=[0,5],zrange=[1,1e4],/add,mpanel=mpanel_Nparaperp,xtit='Vb',ytit='Ve',charsize=charsize
       oplot,!x.crange,[0,0],line=2
       oplot,[0,0],!y.crange,line=2
