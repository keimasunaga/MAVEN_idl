...
pro plot_reflect_ion_map6,energy
    ...
    phi_dash_bin2 = replicate(1.,18) # phi_dash_bin
    phi_dash_bin_edge = ((findgen(73)*5.) - 180.)*!DTOR
    phi_dash_bin_edge2 = replicate(1.,19) # phi_dash_bin_edge
    ...
    ;theta_dash_bin2 = theta_dash_bin # replicate(1.,18)
    theta_dash_bin_edge = findgen(19)*5.*!DTOR    ;; Array of edge of the theta' array with a even gap of 5 degree.
    ;theta_dash_bin_edge2 = theta_dash_bin_edge # replicate(1.,19)
    ...
    for i=0,17 do begin
      for j=0,71 do begin    
          vec12 = [x_dash_bin_edge2[i,j] - x_dash_bin_edge2[i,j+1],y_dash_bin_edge2[i,j] - y_dash_bin_edge2[i,j+1], z_dash_bin_edge2[i,j] - z_dash_bin_edge2[i,j+1]]
          vec14 = [x_dash_bin_edge2[i,j] - x_dash_bin_edge2[i+1,j],y_dash_bin_edge2[i,j] - y_dash_bin_edge2[i+1,j], z_dash_bin_edge2[i,j] - z_dash_bin_edge2[i+1,j]]
          vec13 = [x_dash_bin_edge2[i,j] - x_dash_bin_edge2[i+1,j+1],y_dash_bin_edge2[i,j+1] - y_dash_bin_edge2[i+1,j+1], z_dash_bin_edge2[i,j] - z_dash_bin_edge2[i+1,j+1]]
          
          if i eq 0 then norm_cnt = crossp(vec13,vec14)/norm(vec13)/norm(vec14)
          if i ne 0 then norm_cnt = crossp(vec12,vec14)/norm(vec12)/norm(vec14)
      endfor
       print,norm_cnt
       stop
    endfor
