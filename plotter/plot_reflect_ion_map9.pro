...
pro plot_reflect_ion_map9,energy,vdf_type=vdf_type,surf_type=surf_type,frange=frange,fregion=fregion,$
   ...
   rg_arr = 0.
    ...
    for in=0,n_elements(orbit_arr)-1 do begin  
      ...
      filename = SAVE_LOC + '/maven/sav/flux/deflect_ion/d1/'+string(orbit_arr[in],format='(i05)')+'/flux_vdf_*.sav'   
