...
pro mvn_bksct_bs,r0,E0,azv0,elev0
...
m = 16.d*mi                          ;- mass
q = e                           ;- charge
Vsw0 = [-300.d3,0.d3, 0.d3]       ;- [m/s] solar wind velocity
...
plot,r_rec[*,0]/Rm,r_rec[*,2]/Rm,/iso,xrange=[4,-6],yrange=[-4,4]
...
L = 2.1
Rss = 1.58
t = (findgen(5))*22.5*!DTOR;= findgen(360)*!DTOR
r = L/(1.+e*cos(t))
...
for ii=0,n_elements(Xbs)-1 do begin
    Xi0 = Xbs[ii]
    a = (e^2-1.)*(Xi0+L*e/(1.-e^2))/sqrt((e^2-1.)*(Xi0+L*e/(1.-e^2))^2-L^2/(e^2-1.))
    agl_slp = atan(-1./a)
    print,agl_slp*!radeg
  stop
