...
;; main routine
pro plot_mvn_orbit,time_arr,orbit=orbit,xy=xy,yz=yz,xz=xz,cyl=cyl,all=all,oplot=oplot,$
                   seconds=seconds,frame=frame,show_time=show_time,Bvec=Bvec,Vvec=Vvec,Evec=Evec,len_ratio=len_ratio,$
