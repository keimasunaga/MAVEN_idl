...
pro plot_reflect_ion_map10_v2,energy,vdf_type=vdf_type,surf_type=surf_type,frange=frange,fregion=fregion,$
    ...
    orbit_arr = 317;[317+findgen(450)];[317+findgen(500),1470+findgen(500), 2423+findgen(600)];346;,347,348,349,350] ;+ findgen(472)   
    zrange = [1e0,1e5] 
    zrange_n = [1e0,1e3]
