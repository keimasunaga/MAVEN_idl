...
pro plot_reflect_ion_map7,energy,vdf_type=vdf_type,surf_type=surf_type,frange=frange,fregion=fregion
   
   

    orbit_arr = 336+findgen(500);346;,347,348,349,350] ;+ findgen(472) 
    env = init_env()
   ...
   clock_angle_arr = 0.
    ...
    for in=0,n_elements(orbit_arr)-1 do begin  
      ...
      filename = SAVE_LOC + '/maven/sav/flux/deflect_ion_151122/d0/'+string(orbit_arr[in],format='(i05)')+'/flux_vdf_*.sav'   
      ...
      for ii=0,n_elements(fs)-1 do begin
          ...
          norm_sh = get_norm_shock3(pos_mse,ind=ind)
          ;stop
          ith = ind[0]
          iph = ind[1]
;           norm_sh = [1.,0.,0.]
...
;      if fregion eq 1 then begin
;        j0 = 0 & j1 = 35
;        i0 = 0 & i1 = 8
;      endif
;      if fregion eq 2 then begin
;        j0 = 0 & j1 = 35
;        i0 = 9 & i1 = 17
;      endif
;      if fregion eq 3 then begin
;        j0 = 36 & j1 = 71
;        i0 = 0 & i1 = 8
;      endif
;      if fregion eq 4 then begin
;        j0 = 36 & j1 = 71
;        i0 = 9 & i1 = 17
;      endif
;     
;     if not keyword_set(fregion) then begin
;        j0 = 0 & j1 = 71
;        i0 = 0 & i1 = 17
;     endif 
     ...
     i0 = 0 & i1 = 8   
      ...
      print,'Region 1:',total(rflct_number)
      ...
      print,'Region 2:',total(rflct_number)
      ...
      print,'Region 3:',total(rflct_number)
      ...
      print,'Region 4:',total(rflct_number)
