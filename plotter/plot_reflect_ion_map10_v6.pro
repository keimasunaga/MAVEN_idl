...
pro plot_reflect_ion_map10_v6,median=median,SE=SE,frange=frange,$
    ...
    orbit_arr = 317+findgen(2443);[317+findgen(2412)];[317+findgen(450)];[317+findgen(500),1470+findgen(500), 2423+findgen(600)];346;,347,348,349,350] ;+ findgen(472)   
    zrange = [1e0,1e5] 
    zrange_n = [1e0,1e3]
    Nmin = 3
    env = init_env()
...
;      endif
      ...
      ;; REMOVE 25% ring
      if rmv_ring_percentage eq 25 then begin
        Odens_gt5keV_out = dat_sav_arr.Odens_gt5keV_out_25
        Ovel_sh_gt5keV_out = dat_sav_arr.Ovel_sh_25_gt5keV_out_25
        f_sh_gt5keV_out = Odens_gt5keV_out * Ovel_sh_gt5keV_out
        f_sh_gt5keV_out_arr = [f_sh_gt5keV_out_arr, f_sh_gt5keV_out]
        Odens_gt5keV_in = dat_sav_arr.Odens_gt5keV_in_25
        Ovel_sh_gt5keV_in = dat_sav_arr.Ovel_sh_25_gt5keV_in_25
        f_sh_gt5keV_in = Odens_gt5keV_in * Ovel_sh_gt5keV_in
        f_sh_gt5keV_in_arr = [f_sh_gt5keV_in_arr, f_sh_gt5keV_in]

        Odens_gt10keV_out = dat_sav_arr.Odens_gt10keV_out_25
        Ovel_sh_gt10keV_out = dat_sav_arr.Ovel_sh_25_gt10keV_out_25
        f_sh_gt10keV_out = Odens_gt10keV_out * Ovel_sh_gt10keV_out
        f_sh_gt10keV_out_arr = [f_sh_gt10keV_out_arr, f_sh_gt10keV_out]
        Odens_gt10keV_in = dat_sav_arr.Odens_gt10keV_in_25
        Ovel_sh_gt10keV_in = dat_sav_arr.Ovel_sh_25_gt10keV_in_25
        f_sh_gt10keV_in = Odens_gt10keV_in * Ovel_sh_gt10keV_in
        f_sh_gt10keV_in_arr = [f_sh_gt10keV_in_arr, f_sh_gt10keV_in]

        Odens_20keV_out = dat_sav_arr.Odens_20keV_out_25
        Ovel_sh_20keV_out = dat_sav_arr.Ovel_sh_25_20keV_out_25
        f_sh_20keV_out = Odens_20keV_out * Ovel_sh_20keV_out
        f_sh_20keV_out_arr = [f_sh_20keV_out_arr, f_sh_20keV_out]
        Odens_20keV_in = dat_sav_arr.Odens_20keV_in_25
        Ovel_sh_20keV_in = dat_sav_arr.Ovel_sh_25_20keV_in_25
        f_sh_20keV_in = Odens_20keV_in * Ovel_sh_20keV_in
        f_sh_20keV_in_arr = [f_sh_20keV_in_arr, f_sh_20keV_in]
      endif
      ...
      ;; REMOVE 75% ring   
      if rmv_ring_percentage eq 75 then begin
        Odens_gt5keV_out = dat_sav_arr.Odens_gt5keV_out_75
        Ovel_sh_gt5keV_out = dat_sav_arr.Ovel_sh_75_gt5keV_out_75
        f_sh_gt5keV_out = Odens_gt5keV_out * Ovel_sh_gt5keV_out
        f_sh_gt5keV_out_arr = [f_sh_gt5keV_out_arr, f_sh_gt5keV_out]
        Odens_gt5keV_in = dat_sav_arr.Odens_gt5keV_in_75
        Ovel_sh_gt5keV_in = dat_sav_arr.Ovel_sh_75_gt5keV_in_75
        f_sh_gt5keV_in = Odens_gt5keV_in * Ovel_sh_gt5keV_in
        f_sh_gt5keV_in_arr = [f_sh_gt5keV_in_arr, f_sh_gt5keV_in]

        Odens_gt10keV_out = dat_sav_arr.Odens_gt10keV_out_75
        Ovel_sh_gt10keV_out = dat_sav_arr.Ovel_sh_75_gt10keV_out_75
        f_sh_gt10keV_out = Odens_gt10keV_out * Ovel_sh_gt10keV_out
        f_sh_gt10keV_out_arr = [f_sh_gt10keV_out_arr, f_sh_gt10keV_out]
        Odens_gt10keV_in = dat_sav_arr.Odens_gt10keV_in_75
        Ovel_sh_gt10keV_in = dat_sav_arr.Ovel_sh_75_gt10keV_in_75
        f_sh_gt10keV_in = Odens_gt10keV_in * Ovel_sh_gt10keV_in
        f_sh_gt10keV_in_arr = [f_sh_gt10keV_in_arr, f_sh_gt10keV_in]

        Odens_20keV_out = dat_sav_arr.Odens_20keV_out_75
        Ovel_sh_20keV_out = dat_sav_arr.Ovel_sh_75_20keV_out_75
        f_sh_20keV_out = Odens_20keV_out * Ovel_sh_20keV_out
        f_sh_20keV_out_arr = [f_sh_20keV_out_arr, f_sh_20keV_out]
        Odens_20keV_in = dat_sav_arr.Odens_20keV_in_75
        Ovel_sh_20keV_in = dat_sav_arr.Ovel_sh_75_20keV_in_75
        f_sh_20keV_in = Odens_20keV_in * Ovel_sh_20keV_in
        f_sh_20keV_in_arr = [f_sh_20keV_in_arr, f_sh_20keV_in]
      endif
...
;    Mach_arr = Vmso_t_arr/Va_arr
  ...
  ;;;;;;;;;;;;;;;;;;;;;;;;;;
    if keyword_set(sw_dpnd) then begin
      ...
      dNsw = 0.5
      Nsw_hist = histogram(Nsw_arr,binsize=dNsw,locations=hist_loc_Nsw,min=0.,max=round(max(Nsw_arr)/dNsw)*dNsw+dNsw)
      hist_bins_Nsw = hist_loc_Nsw + dNsw/2.
      plot,hist_bins_Nsw,Nsw_hist,psym=10,xrange=[0,30],/xsty,charsize=charsize,xtit='Nsw [cm-3]'
      oplot,[hist_bins_Nsw[0]-dNsw/2.,hist_bins_Nsw[0]-dNsw/2.],[0.,Nsw_hist[0]]
      oplot,[hist_bins_Nsw[0]-dNsw/2.,hist_bins_Nsw[0]],[Nsw_hist[0],Nsw_hist[0]]
      ;oplot,[hist_bins_Nsw[n_elements(Nsw_hist)-1]+dNsw,hist_bins_Nsw[n_elements(Nsw_hist)-1]+dNsw/2.],[0.,Nsw_hist[n_elements(Nsw_hist)-1]]
      ;oplot,[hist_bins_Nsw[n_elements(Nsw_hist)-1],hist_bins_Nsw[n_elements(Nsw_hist)-1]+dNsw/2.],[Nsw_hist[n_elements(Nsw_hist)-1],Nsw_hist[n_elements(Nsw_hist)-1]]
      ...
      dV = 20
      V_hist = histogram(Vmso_t_arr,binsize=dV,locations=hist_loc_V,min=0.,max=round(max(Vmso_t_arr)/dV)*dV+dV)
      hist_bins_V = hist_loc_V + dV/2.;( findgen( n_elements(Vmso_t_arr) ) * dV ) + min( Vmso_t_arr )
      plot,hist_bins_V,V_hist,psym=10,xrange=[0,700],charsize=charsize,xtit='Vsw [km/s]'
      oplot,[hist_bins_V[0]-dV/2.,hist_bins_V[0]-dV/2.],[0.,V_hist[0]]
      oplot,[hist_bins_V[0]-dV/2.,hist_bins_V[0]],[V_hist[0],V_hist[0]]
...
;      oplot,[mean(Vperp_arr),mean(Vperp_arr)],[!y.crange[0],!y.crange[1]],line=2,color=200
      ...
      dBt = 0.5
      Bt_hist = histogram(Bmso_t_arr,binsize=dBt,locations=hist_loc_Bt,min=0.,max=round(max(Bmso_t_arr)/dBt)*dBt+dBt)
      hist_bins_Bt = hist_loc_Bt + dBt/2.;( findgen( n_elements(Bmso_t_arr) ) * dBt ) + min( Bmso_t_arr )
      plot,hist_bins_Bt,Bt_hist,psym=10,xrange=[0,20],charsize=charsize,xtit='Bt [nT]',yrange=[0,1.4e4],/ysty
      oplot,[hist_bins_Bt[0]-dBt/2.,hist_bins_Bt[0]-dBt/2.],[0.,Bt_hist[0]]
      oplot,[hist_bins_Bt[0]-dBt/2.,hist_bins_Bt[0]],[Bt_hist[0],Bt_hist[0]]
      ...
      ;if keyword_set(cone) then begin
        dcone = 5
        cone_hist = histogram(cone_agl_arr,binsize=dcone,locations=hist_loc_cone,min=0.,max=round(max(cone_agl_arr)/dcone)*dcone+dcone)
        hist_bins_cone = hist_loc_cone + dcone/2.;( findgen( n_elements(cone_agl_arr) ) * dcone ); + min( cone_agl_arr )
        plot,hist_bins_cone,cone_hist,psym=10,xrange=[0,180],/xsty,charsize=charsize,xtit='Cone angle [degree]'
        oplot,[hist_bins_cone[0]-dcone/2.,hist_bins_cone[0]-dcone/2.],[0.,cone_hist[0]]
        oplot,[hist_bins_cone[0]-dcone/2.,hist_bins_cone[0]],[cone_hist[0],cone_hist[0]]
      ...
      dPdy = 0.1
      Pdy_hist = histogram(Pdy_arr,binsize=dPdy,locations=hist_loc_Pdy,min=0.,max=round(max(Pdy_arr)/dPdy)*dPdy+dPdy)
      hist_bins_Pdy = hist_loc_Pdy + dPdy/2. ;( findgen( n_elements(Pdy_arr) ) * dPdy) + min( Pdy_arr )
      plot,hist_bins_Pdy,Pdy_hist,psym=10,xrange=[0,5],charsize=charsize,xtit='Pdy [nPa]'
      oplot,[hist_bins_Pdy[0]-dPdy/2.,hist_bins_Pdy[0]-dPdy/2.],[0.,Pdy_hist[0]]
      oplot,[hist_bins_Pdy[0]-dPdy/2.,hist_bins_Pdy[0]],[Pdy_hist[0],Pdy_hist[0]]
      ...
      dRg = 0.5
      Rg_hist = histogram(Rg_arr,binsize=dRg,locations=hist_loc_Rg,min=0.,max=round(max(Rg_arr)/dRg)*dRg+dRg)
      hist_bins_Rg = hist_loc_Rg + dRg/2. ;( findgen( n_elements(Rg_arr) ) * dRg ) + min( Rg_arr )
      plot,hist_bins_Rg,Rg_hist,psym=10,xrange=[0,30],charsize=charsize,xtit='Rg [Rm]'
      oplot,[hist_bins_Rg[0]-dRg/2.,hist_bins_Rg[0]-dRg/2.],[0.,Rg_hist[0]]
      oplot,[hist_bins_Rg[0]-dRg/2.,hist_bins_Rg[0]],[Rg_hist[0],Rg_hist[0]]
...
;      endif
      ...
      if keyword_set(Mach) then begin
        dMach = 0.5
        Mach_hist = histogram(Mach_arr,binsize=dMach,locations=hist_loc_Mach,min=0.,max=round(max(Mach_arr)/dMach)*dMach+dMach)
        hist_bins_Mach = hist_loc_Mach + dMach/2. ;( findgen( n_elements(Mach_arr) ) * dMach ) + min( Mach_arr )
        plot,hist_bins_Mach,Mach_hist,psym=10,xrange=[0,10],charsize=charsize,xtit='Mach number'
        oplot,[hist_bins_Mach[0]-dMach/2.,hist_bins_Mach[0]-dMach/2.],[0.,Mach_hist[0]]
        oplot,[hist_bins_Mach[0]-dMach/2.,hist_bins_Mach[0]],[Mach_hist[0],Mach_hist[0]]
      ...
      if keyword_set(Bsheath) then begin
        ...
        plot,hist_bins_Bsheath+dsheath/2.,Bsheath_hist,psym=10,xrange=[0,60],charsize=charsize,xtit='Sheath Field [nT]'
      ...
      if keyword_set(euv) then begin
      deuv = 0.00001
      euv_hist = histogram(euv_arr,binsize=deuv,locations=hist_loc_euv,min=0.,max=round(max(euv_arr)/deuv)*deuv+deuv)
      hist_bins_euv = hist_loc_euv + deuv/2. ;( findgen( n_elements(euv_arr) ) * deuv ) + min( euv_arr )
      plot,hist_bins_euv,euv_hist,psym=10,xrange=[0,0.0008],charsize=charsize,xtit='EUV (17-22nm) [W/m^2]'
      oplot,[hist_bins_euv[0]-deuv/2.,hist_bins_euv[0]-deuv/2.],[0.,euv_hist[0]]
      oplot,[hist_bins_euv[0]-deuv/2.,hist_bins_euv[0]],[euv_hist[0],euv_hist[0]]
      ...
      oplot,[2,3],[nnight,nnight]
       ...
       if keyword_set(dens) then begin
         ...
         print,n_elements(idx_sort),'VDFs are used. (Nsw)'
       endif
       ...
       if keyword_set(Vt) then begin
         ...
         print,n_elements(idx_sort),'VDFs are used. (Vt)'
       endif
       ...
       if keyword_set(Bt) then begin
         ...
         print,n_elements(idx_sort),'VDFs are used. (Bt)' 
       endif
       ...
       if keyword_set(cone) then begin
         ...
         print,n_elements(idx_sort),'VDFs are used. (Cone)'
       endif
       ...
       if keyword_set(Pdy) then begin
         ...
         print,n_elements(idx_sort),'VDFs are used. (Pdy)'
       endif
       ...
       if keyword_set(Rg) then begin
         ...
         print,n_elements(idx_sort),'VDFs are used. (Rg)'
       endif
       ...
       if keyword_set(Mach) then begin
         ...
         print,n_elements(idx_sort),'VDFs are used. (Mach)'
       endif
       ...
       if keyword_set(euv) then begin
         ...
         print,n_elements(idx_sort),'VDFs are used. (EUV)'
       endif
       ...
       if keyword_set(Bcrst) then begin
         ...
         print,n_elements(idx_sort),'VDFs are used. (Bcrst)'
       endif
       
       idx_sort = where(   Bmso_t_arr gt  6   )
       idx_a = where(Bmso_t_arr gt  6 and f_sh_gt10keV_out_arr gt 10000.)
       idx_b = where(f_sh_gt10keV_out_arr/f_sh_gt10keV_in_arr gt 0.3 and Bmso_t_arr gt  6)
       ;idx_sort = where( Pos_crst_mso[0,*] le 0 and Pdy_arr gt median(Pdy_arr) )
       ;idx_sort = where( Rg_arr ge 8 )
       print,n_elements(idx_sort),' VDFs are used.'
       ;print,median(Pdy_arr[idx_sort]),median(Rg_arr[idx_sort])
       stop
      ...
      for i=0,71 do begin
        for j=0,17 do begin
          ...
          if n_elements(idx) ge Nmin then begin ;if idx[0] ne -1 then begin
          ...
          if n_f[j,i] lt Nmin then clr = 255
...
;                  endif
               ...
               if keyword_set(SE) then f_out_gt10keV_err[j,i] = stddev(f_sh_gt10keV_out_arr[idx])/sqrt(n_elements(idx)) else f_out_gt10keV_err[j,i] = stddev(f_sh_gt10keV_out_arr[idx])
...
;                                 dfin = 500
;                                 fin_hist = histogram(f_sh_gt10keV_in_arr[idx],binsize=dfin)
;                                 hist_bins_fin = ( findgen( n_elements(f_sh_gt10keV_in_arr[idx]) ) * dfin ) + min( f_sh_gt10keV_in_arr[idx] )
;                                 plot,hist_bins_fin,fin_hist,psym=10,xrange=[0,5000],charsize=charsize,xtit='Flux [cm-2 s-1]'
;                                 stop
;                                 endif
               
               if keyword_set(SE) then f_in_gt10keV_err[j,i] = stddev(f_sh_gt10keV_in_arr[idx])/sqrt(n_elements(idx)) else f_in_gt10keV_err[j,i] = stddev(f_sh_gt10keV_in_arr[idx])
               n_f[j,i] = n_elements(idx)
             endif
;           
     ...
     i0_3 = 0 & i1_3 = 8   
      ...
      for j=j0, j1 do begin
        for i=i0,i1 do begin
          if i eq 0 then begin
            idx = where((bin_theta_phi_arr[0,*] eq i) and (bin_theta_phi_arr[1,*] eq j))
            if n_elements(idx) ge Nmin then begin
            ;;Rates in each bin
