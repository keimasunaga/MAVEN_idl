pro tplot_mvn_pfp_bk,sd=sd,ndays=ndays,sorb=sorb,norb=norb,png=png,save=save,notplot=notplot
...
;       t_rename,'MAVEN_POS_(Mars-MSO)_z','Zmso'
     ...
     ;; sep load
       ...
       get_data,'mvn_sep1_A-F_Eflux_Energy',data=sep1a,dlim=dl_1a
       get_data,'mvn_sep2_A-F_Eflux_Energy',data=sep2a,dlim=dl_2a  
       get_data,'mvn_sep1_B-O_Eflux_Energy',data=sep1b,dlim=dl_1b
       get_data,'mvn_sep2_B-O_Eflux_Energy',data=sep2b,dlim=dl_2b     
       idx_real_1a = where(finite(sep1a.x) ne 0)
       idx_real_2a = where(finite(sep2a.x) ne 0)
       idx_real_1b = where(finite(sep1b.x) ne 0)
       idx_real_2b = where(finite(sep2b.x) ne 0)
      
       idx_znorm = tag_exist(sep1a,'znorm')
       if idx_znorm eq 1 then begin
          if idx_real_1a[0] ne -1 then store_data,'mvn_sep1_A-F_Eflux_Energy',data={x:sep1a.x[idx_real_1a], y:sep1a.y[idx_real_1a,*], v:sep1a.v, znorm:sep1a.znorm[idx_real_1a,*], map:sep1a.map},dlim=dl_1a
          if idx_real_2a[0] ne -1 then store_data,'mvn_sep2_A-F_Eflux_Energy',data={x:sep2a.x[idx_real_2a], y:sep2a.y[idx_real_2a,*], v:sep2a.v, znorm:sep2a.znorm[idx_real_2a,*], map:sep2a.map},dlim=dl_2a
          if idx_real_1b[0] ne -1 then store_data,'mvn_sep1_B-O_Eflux_Energy',data={x:sep1b.x[idx_real_1b], y:sep1b.y[idx_real_1b,*], v:sep1b.v, znorm:sep1b.znorm[idx_real_1b,*], map:sep1b.map},dlim=dl_1b
          if idx_real_2b[0] ne -1 then store_data,'mvn_sep2_B-O_Eflux_Energy',data={x:sep2b.x[idx_real_2b], y:sep2b.y[idx_real_2b,*], v:sep2b.v, znorm:sep2b.znorm[idx_real_2b,*], map:sep2b.map},dlim=dl_2b
       endif
       
       replace_tvar_trange,'mvn_sep1_A-F_Eflux_Energy',[st,et]
       replace_tvar_trange,'mvn_sep1_B-O_Eflux_Energy',[st,et]
       replace_tvar_trange,'mvn_sep2_A-F_Eflux_Energy',[st,et]
       replace_tvar_trange,'mvn_sep2_B-O_Eflux_Energy',[st,et]
...
;       store_data,'orbnum',data={x:t, y:mvn_orbit_num(time=t)}
       ...
       if ~keyword_set(png) then begin
          if n_elements(idx_ca) eq 2 then if idx_ca[0] and idx_ca[1] eq 1 then tplot,['mvn_sep1_B-O_Eflux_Energy', 'mvn_sep2_B-O_Eflux_Energy','mvn_swe_et_spec_svy','mvn_sta_c0_E','mvn_sta_c0_H_E','mvn_sta_c6_M','mvn_swica_en_eflux','mvn_swica_density','mvn_swica_velocity_mso_all','mvn_swica_pdy','mvn_B_1sec_MAVEN_MSO_all','alt2','sza'] $
          ...
          if n_elements(idx_ca) eq 1 then if idx_ca eq 1 then tplot,['mvn_sep1_B-O_Eflux_Energy', 'mvn_sep2_B-O_Eflux_Energy','mvn_swe_et_spec_svy','mvn_sta_c0_E','mvn_sta_c0_H_E','mvn_sta_c6_M','mvn_swica_en_eflux','mvn_swica_density','mvn_swica_velocity_mso_all','mvn_swica_pdy','mvn_B_1sec_MAVEN_MSO_all','alt2','sza'] $
          else tplot,['mvn_sep1_B-O_Eflux_Energy', 'mvn_sep2_B-O_Eflux_Energy','mvn_swe_et_spec_svy','mvn_sta_c0_E','mvn_sta_c0_H_E','mvn_sta_c6_M','mvn_swics_en_eflux','mvn_swics_density','mvn_swics_velocity_mso_all','mvn_swics_pdy','mvn_B_1sec_MAVEN_MSO_all','alt2','sza']
           ...
           if !version.os eq 'darwin' then begin
             ...
             if sdate eq edate then begin
              if idx_ca eq 1 then tplot,['mvn_sep1_B-O_Eflux_Energy', 'mvn_sep2_B-O_Eflux_Energy','mvn_swe_et_spec_svy','mvn_sta_c0_E','mvn_sta_c0_H_E','mvn_sta_c6_M','mvn_swica_en_eflux','mvn_swica_density','mvn_swica_velocity_mso_all','mvn_swica_pdy','mvn_B_1sec_MAVEN_MSO_all','alt2','sza'] $
               ...
               if idx_ca_1 eq 1 and idx_ca_2 eq 1 then tplot,['mvn_sep1_B-O_Eflux_Energy', 'mvn_sep2_B-O_Eflux_Energy','mvn_swe_et_spec_svy','mvn_sta_c0_E','mvn_sta_c0_H_E','mvn_sta_c6_M','mvn_swica_en_eflux','mvn_swica_density','mvn_swica_velocity_mso_all','mvn_swica_pdy','mvn_B_1sec_MAVEN_MSO_all','alt2','sza'] $
               else tplot,['mvn_sep1_B-O_Eflux_Energy', 'mvn_sep2_B-O_Eflux_Energy','mvn_swe_et_spec_svy','mvn_sta_c0_E','mvn_sta_c0_H_E','mvn_sta_c6_M','mvn_swics_en_eflux','mvn_swics_density','mvn_swics_velocity_mso_all','mvn_swics_pdy','mvn_B_1sec_MAVEN_MSO_all','alt2','sza']     
             endelse 
             makepng,filename
           endif else begin
       ...
       if keyword_set(save) then begin
         if keyword_set(sd) then begin
           ...
           tplot_save,['mvn_sep1_A-F_Eflux_Energy', 'mvn_sep2_A-F_Eflux_Energy','mvn_sep1_B-O_Eflux_Energy', 'mvn_sep2_B-O_Eflux_Energy',$
                       'mvn_swe_et_spec_svy',$
