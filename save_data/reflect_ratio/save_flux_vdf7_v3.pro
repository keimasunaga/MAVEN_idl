...
pro save_flux_vdf7_v3,orbit,trange=trange,png=png,ps2pdf=ps2pdf,ps2png=ps2png,save=save,event=event,highres=highres,_extra=extra,get_apid=get_apid,$
  ...
  for it = 0,n_elements(time)-1 do begin
    ...
    flux_vdf7_v3,dat_new,orbit=orbit,/local,/show,units='df',sta_apid=get_apid,mult='4,5',panel_mode=3,nbin=800,vres=2.,$
      /remove,_extra={charsize:1.5},mass_assmpt=16.,mass_range=[12,20],angle=[-45,45],/surf,$
      plot_vdf=plot_vdf,/bsedge_care
       
    flux_vdf7_v3,dat_new,orbit=orbit,/local,/show,units='df',sta_apid=get_apid,mult='4,5',panel_mode=1,nbin=800,vres=2.,$
    ...
    flux_vdf7_v3,dat_new,orbit=orbit,/local,/show,units='df',sta_apid=get_apid,mult='4,5',panel_mode=2,nbin=800,vres=2.,$
...
;      endelse
    ...
    if keyword_set(save) then begin
     ...
     dat_sav = {Time:vdf_sav_out_sh.time, Pos_mso:vdf_sav_out_sh.pos_mso, Pos_mse:vdf_sav_out_sh.pos_mse, $
      
                Odens_100eV_out:vdf_sav_out_sh.Odens_100eV, Ovel_mso_100eV_out:vdf_sav_out_sh.Ovel_mso_100eV,$
                Odens_1keV_out:vdf_sav_out_sh.Odens_1keV, Ovel_mso_1keV_out:vdf_sav_out_sh.Ovel_mso_1keV,$
                Odens_5keV_out:vdf_sav_out_sh.Odens_5keV, Ovel_mso_5keV_out:vdf_sav_out_sh.Ovel_mso_5keV,$
                Odens_10keV_out:vdf_sav_out_sh.Odens_10keV, Ovel_mso_10keV_out:vdf_sav_out_sh.Ovel_mso_10keV,$
                Odens_20keV_out:vdf_sav_out_sh.Odens_20keV, Ovel_mso_20keV_out:vdf_sav_out_sh.Ovel_mso_20keV,$
                Odens_gt1keV_out:vdf_sav_out_sh.Odens_gt1keV, Ovel_mso_gt1keV_out:vdf_sav_out_sh.Ovel_mso_gt1keV,$
                Odens_gt5keV_out:vdf_sav_out_sh.Odens_gt5keV, Ovel_mso_gt5keV_out:vdf_sav_out_sh.Ovel_mso_gt5keV,$
                Odens_gt10keV_out:vdf_sav_out_sh.Odens_gt10keV, Ovel_mso_gt10keV_out:vdf_sav_out_sh.Ovel_mso_gt10keV,$
                Odens_all_out:vdf_sav_out_sh.Odens_all, Ovel_mso_all_out:vdf_sav_out_sh.Ovel_mso_all,$
                
                Odens_100eV_in:vdf_sav_in_sh.Odens_100eV, Ovel_mso_100eV_in:vdf_sav_in_sh.Ovel_mso_100eV,$
                Odens_1keV_in:vdf_sav_in_sh.Odens_1keV, Ovel_mso_1keV_in:vdf_sav_in_sh.Ovel_mso_1keV,$
                Odens_5keV_in:vdf_sav_in_sh.Odens_5keV, Ovel_mso_5keV_in:vdf_sav_in_sh.Ovel_mso_5keV,$
                Odens_10keV_in:vdf_sav_in_sh.Odens_10keV, Ovel_mso_10keV_in:vdf_sav_in_sh.Ovel_mso_10keV,$
                Odens_20keV_in:vdf_sav_in_sh.Odens_20keV, Ovel_mso_20keV_in:vdf_sav_in_sh.Ovel_mso_20keV,$
                Odens_gt1keV_in:vdf_sav_in_sh.Odens_gt1keV, Ovel_mso_gt1keV_in:vdf_sav_in_sh.Ovel_mso_gt1keV,$
                Odens_gt5keV_in:vdf_sav_in_sh.Odens_gt5keV, Ovel_mso_gt5keV_in:vdf_sav_in_sh.Ovel_mso_gt5keV,$
                Odens_gt10keV_in:vdf_sav_in_sh.Odens_gt10keV, Ovel_mso_gt10keV_in:vdf_sav_in_sh.Ovel_mso_gt10keV,$
                Odens_all_in:vdf_sav_in_sh.Odens_all, Ovel_mso_all_in:vdf_sav_in_sh.Ovel_mso_all,$
                
                DENS:vdf_sav_out_sh.dens, DENS_STD:vdf_sav_out_sh.dens_std, $
                VMSO:vdf_sav_out_sh.vmso, VMSO_STD:vdf_sav_out_sh.vmso_std, $
                BMSO:vdf_sav_out_sh.bmso, BMSO_STD:vdf_sav_out_sh.bmso_std, $
                THETA_B:vdf_sav_out_sh.theta_b, THETA_B_STD:vdf_sav_out_sh.theta_b_std, $
                PHI_B:vdf_sav_out_sh.phi_b,$
                R_B:vdf_sav_out_sh.r_b, $
                ZTEST_B:vdf_sav_out_sh.ztest_b,$
                THETA_V:vdf_sav_out_sh.theta_v, THETA_V_STD:vdf_sav_out_sh.theta_v_std,$
                PHI_V:vdf_sav_out_sh.phi_v,$
                R_V:vdf_sav_out_sh.r_v, $
                ZTEST_V:vdf_sav_out_sh.ztest_v}
