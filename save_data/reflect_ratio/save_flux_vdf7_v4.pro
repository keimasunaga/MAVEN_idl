...
pro save_flux_vdf7_v4,orbit,trange=trange,png=png,ps2pdf=ps2pdf,ps2png=ps2png,save=save,event=event,highres=highres,_extra=extra,get_apid=get_apid,$
...
;    endif
    ...
    if size(flux_sav_out_sh,/type) ne 8 then goto, no_data 
 
     dat_sav = {Stime:flux_sav_out_sh.time[0], Etime: flux_sav_out_sh.time[1], Pos_mso:pos, Pos_mse:transpose(flux_sav_out_sh.pos_mse), $
                theta_bs:flux_sav_out_sh.theta_bs, phi_bs:flux_sav_out_sh.phi_bs, bin_theta_phi:flux_sav_out_sh.bin_theta_phi,$
                
                Odens_100eV_out:flux_sav_out_sh.Odens_100eV, Ovel_mso_100eV_out:flux_sav_out_sh.Ovel_mso_100eV, Ovel_mse_100eV_out:flux_sav_out_sh.Ovel_mse_100eV, Ovel_sh_100eV_out:flux_sav_out_sh.Ovel_sh_100eV,$
                Odens_1keV_out:flux_sav_out_sh.Odens_1keV, Ovel_mso_1keV_out:flux_sav_out_sh.Ovel_mso_1keV, Ovel_mse_1keV_out:flux_sav_out_sh.Ovel_mse_1keV, Ovel_sh_1keV_out:flux_sav_out_sh.Ovel_sh_1keV,$
                Odens_5keV_out:flux_sav_out_sh.Odens_5keV, Ovel_mso_5keV_out:flux_sav_out_sh.Ovel_mso_5keV, Ovel_mse_5keV_out:flux_sav_out_sh.Ovel_mse_5keV, Ovel_sh_5keV_out:flux_sav_out_sh.Ovel_sh_5keV,$
                Odens_10keV_out:flux_sav_out_sh.Odens_10keV, Ovel_mso_10keV_out:flux_sav_out_sh.Ovel_mso_10keV, Ovel_mse_10keV_out:flux_sav_out_sh.Ovel_mse_10keV, Ovel_sh_10keV_out:flux_sav_out_sh.Ovel_sh_10keV,$
                Odens_20keV_out:flux_sav_out_sh.Odens_20keV, Ovel_mso_20keV_out:flux_sav_out_sh.Ovel_mso_20keV, Ovel_mse_20keV_out:flux_sav_out_sh.Ovel_mse_20keV, Ovel_sh_20keV_out:flux_sav_out_sh.Ovel_sh_20keV,$
                Odens_gt1keV_out:flux_sav_out_sh.Odens_gt1keV, Ovel_mso_gt1keV_out:flux_sav_out_sh.Ovel_mso_gt1keV, Ovel_mse_gt1keV_out:flux_sav_out_sh.Ovel_mse_gt1keV, Ovel_sh_gt1keV_out:flux_sav_out_sh.Ovel_sh_gt1keV,$
                Odens_gt5keV_out:flux_sav_out_sh.Odens_gt5keV, Ovel_mso_gt5keV_out:flux_sav_out_sh.Ovel_mso_gt5keV, Ovel_mse_gt5keV_out:flux_sav_out_sh.Ovel_mse_gt5keV, Ovel_sh_gt5keV_out:flux_sav_out_sh.Ovel_sh_gt5keV,$
                Odens_gt10keV_out:flux_sav_out_sh.Odens_gt10keV, Ovel_mso_gt10keV_out:flux_sav_out_sh.Ovel_mso_gt10keV, Ovel_mse_gt10keV_out:flux_sav_out_sh.Ovel_mse_gt10keV, Ovel_sh_gt10keV_out:flux_sav_out_sh.Ovel_sh_gt10keV,$
                Odens_all_out:flux_sav_out_sh.Odens_all, Ovel_mso_all_out:flux_sav_out_sh.Ovel_mso_all, Ovel_mse_all_out:flux_sav_out_sh.Ovel_mse_all, Ovel_sh_all_out:flux_sav_out_sh.Ovel_sh_all,$
                
                Odens_100eV_in:flux_sav_in_sh.Odens_100eV, Ovel_mso_100eV_in:flux_sav_in_sh.Ovel_mso_100eV, Ovel_mse_100eV_in:flux_sav_in_sh.Ovel_mse_100eV, Ovel_sh_100eV_in:flux_sav_in_sh.Ovel_sh_100eV,$
                Odens_1keV_in:flux_sav_in_sh.Odens_1keV, Ovel_mso_1keV_in:flux_sav_in_sh.Ovel_mso_1keV, Ovel_mse_1keV_in:flux_sav_in_sh.Ovel_mse_1keV, Ovel_sh_1keV_in:flux_sav_in_sh.Ovel_sh_1keV,$
                Odens_5keV_in:flux_sav_in_sh.Odens_5keV, Ovel_mso_5keV_in:flux_sav_in_sh.Ovel_mso_5keV, Ovel_mse_5keV_in:flux_sav_in_sh.Ovel_mse_5keV, Ovel_sh_5keV_in:flux_sav_in_sh.Ovel_sh_5keV,$
                Odens_10keV_in:flux_sav_in_sh.Odens_10keV, Ovel_mso_10keV_in:flux_sav_in_sh.Ovel_mso_10keV, Ovel_mse_10keV_in:flux_sav_in_sh.Ovel_mse_10keV, Ovel_sh_10keV_in:flux_sav_in_sh.Ovel_sh_10keV,$
                Odens_20keV_in:flux_sav_in_sh.Odens_20keV, Ovel_mso_20keV_in:flux_sav_in_sh.Ovel_mso_20keV, Ovel_mse_20keV_in:flux_sav_in_sh.Ovel_mse_20keV, Ovel_sh_20keV_in:flux_sav_in_sh.Ovel_sh_20keV,$
                Odens_gt1keV_in:flux_sav_in_sh.Odens_gt1keV, Ovel_mso_gt1keV_in:flux_sav_in_sh.Ovel_mso_gt1keV, Ovel_mse_gt1keV_in:flux_sav_in_sh.Ovel_mse_gt1keV, Ovel_sh_gt1keV_in:flux_sav_in_sh.Ovel_sh_gt1keV,$
                Odens_gt5keV_in:flux_sav_in_sh.Odens_gt5keV, Ovel_mso_gt5keV_in:flux_sav_in_sh.Ovel_mso_gt5keV, Ovel_mse_gt5keV_in:flux_sav_in_sh.Ovel_mse_gt5keV, Ovel_sh_gt5keV_in:flux_sav_in_sh.Ovel_sh_gt5keV,$
                Odens_gt10keV_in:flux_sav_in_sh.Odens_gt10keV, Ovel_mso_gt10keV_in:flux_sav_in_sh.Ovel_mso_gt10keV, Ovel_mse_gt10keV_in:flux_sav_in_sh.Ovel_mse_gt10keV, Ovel_sh_gt10keV_in:flux_sav_in_sh.Ovel_sh_gt10keV,$
                Odens_all_in:flux_sav_in_sh.Odens_all, Ovel_mso_all_in:flux_sav_in_sh.Ovel_mso_all, Ovel_mse_all_in:flux_sav_in_sh.Ovel_mse_all, Ovel_sh_all_in:flux_sav_in_sh.Ovel_sh_all,$
  ...
  if size(dat_sav_arr,/type) eq 8 then save,dat_sav_arr,file=save_path+'/flux_vdf_'+string(orbit,format='(i05)')+'.sav'
  no_save:
