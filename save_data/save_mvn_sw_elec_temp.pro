pro save_mvn_sw_elec_temp,orbit=orbit,date=date,month=month,daysinmonth=daysinmonth
...
;      get_data,'valpha',data=valpha
      ...
      mom_elec = {swe_dens:swe_dens, swe_temp:swe_temp};,$
;        nproton:nproton, tproton:tproton, vproton:vproton,$
;        nalpha:nalpha, talpha:talpha, valpha:valpha}

      save,mom_elec, file=SAVE_LOC + '/maven/sav/moment/swe/daily/swe_mom_'+date+'.sav' 
